...
🔹 Product Details – View specifications, usage instructions, and safety guidelines.

🔹 Online Purchase – Order the device easily through a secure purchase page.
...
git clone https://github.com/YourUsername/skin-device-website.git

Open the website:
Open index.html in your preferred browser.

Explore the site:
Navigate through pages to learn about the device and purchase it.
